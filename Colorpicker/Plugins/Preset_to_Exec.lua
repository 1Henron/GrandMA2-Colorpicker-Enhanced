...
function getPresetRangeFromUser ()
  local presetRange = {}
  presetRange['type'] = tonumber(gma.textinput('Preset TYPE', '4'))
  presetRange['first'] = tonumber(gma.textinput('Preset START', '1'))
  presetRange['last'] = tonumber(gma.textinput('Preset END', '12'))
  return presetRange
end
...
function getTargetExecutorFromUser ()
  local executorNumber = gma.textinput('EXECUTOR', '99.1')
